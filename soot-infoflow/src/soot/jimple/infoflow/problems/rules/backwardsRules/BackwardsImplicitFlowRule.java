...
//                List<Unit> condUnit = manager.getICFG().getConditionalBranches(callSite);
//                if (condUnit != null) {
//                    Abstraction intraRet = source.deriveNewAbstractionWithDominator(new UnitContainer(condUnit.get(0)), stmt);
