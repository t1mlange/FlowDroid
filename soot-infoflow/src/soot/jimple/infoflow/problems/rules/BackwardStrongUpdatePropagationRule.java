 ...
 *
 */
public class BackwardStrongUpdatePropagationRule extends AbstractTaintPropagationRule {

	public BackwardStrongUpdatePropagationRule(InfoflowManager manager, Abstraction zeroValue,
