...
public class TaintBenchTests extends FlowDroidTests {
    ...
    static {
        ...
        // CG problem?
        //        resultMap.put("beita_com_beita_contact.apk", new ExpectedResult("<android.content.ContentResolver: android.database.Cursor query(android.net.Uri,java.lang.String[],java.lang.String,java.lang.String[],java.lang.String)>", "com.beita.contact.MyContacts", "getContactsInfoListFromPhone", "<java.io.BufferedWriter: void write(java.lang.String)>", "com.beita.contact.ContactUtil", "void write"));
//        resultMap.put("beita_com_beita_contact.apk", new ExpectedResult("<android.content.ContentResolver: android.database.Cursor query(android.net.Uri,java.lang.String[],java.lang.String,java.lang.String[],java.lang.String)>", "com.beita.contact.MyContacts", "getContactsInfoListFromPhone", "<javax.mail.Transport: void sendMessage(javax.mail.Message,javax.mail.Address[])>", "com.beita.contact.MailUtil", "void sendByJavaMail"));
        resultMap.put("chulia.apk", new ExpectedResult("<android.content.ContentResolver: android.database.Cursor query(android.net.Uri,java.lang.String[],java.lang.String,java.lang.String[],java.lang.String)>", "com.google.services.AlarmService", "getPhoneContacts", "<org.apache.http.impl.client.DefaultHttpClient: org.apache.http.HttpResponse execute(org.apache.http.client.methods.HttpUriRequest)>", "com.google.services.SendInfo", "run"));
        resultMap.put("chulia.apk", new ExpectedResult("<android.content.ContentResolver: android.database.Cursor query(android.net.Uri,java.lang.String[],java.lang.String,java.lang.String[],java.lang.String)>", "com.google.services.AlarmService", "getRecord", "<org.apache.http.impl.client.DefaultHttpClient: org.apache.http.HttpResponse execute(org.apache.http.client.methods.HttpUriRequest)>", "com.google.services.SendInfo", "run"));
        resultMap.put("chulia.apk", new ExpectedResult("<android.content.ContentResolver: android.database.Cursor query(android.net.Uri,java.lang.String[],java.lang.String,java.lang.String[],java.lang.String)>", "com.google.services.AlarmService", "getSms", "<org.apache.http.impl.client.DefaultHttpClient: org.apache.http.HttpResponse execute(org.apache.http.client.methods.HttpUriRequest)>", "com.google.services.SendInfo", "run"));
        resultMap.put("chulia.apk", new ExpectedResult("<android.location.Location: double getLongitude()>", "com.google.services.AlarmService", "updateWithNewLocation", "<org.apache.http.impl.client.DefaultHttpClient: org.apache.http.HttpResponse execute(org.apache.http.client.methods.HttpUriRequest)>", "com.google.services.SendInfo", "void run"));
        ...
        resultMap.put("fakeappstore.apk", new ExpectedResult("<android.telephony.TelephonyManager: java.lang.String getDeviceId()>", "com.google.games.stores.util.GeneralUtil", "String getDevice", "<org.apache.http.client.HttpClient: org.apache.http.HttpResponse execute(org.apache.http.client.methods.HttpUriRequest)>", "com.google.games.stores.util.NetTask", "doInBackground"));
        ...
        resultMap.put("fakebank_android_samp.apk", new ExpectedResult("<android.telephony.TelephonyManager: java.lang.String getSimSerialNumber()>", "com.example.smsmanager.BootCompleteBroadcastReceiver", "onReceive", "<java.net.HttpURLConnection: java.io.InputStream getInputStream()>", "cn.smsmanager.internet.HttpRequest", "byte[] sendGetRequest"));
...
//        resultMap.put("fakedaum.apk", new ExpectedResult("<android.telephony.SmsMessage: android.telephony.SmsMessage createFromPdu(byte[])>", "com.mvlove.receiver.SmsReceiver", "onReceive", "<org.apache.http.client.HttpClient: org.apache.http.HttpResponse execute(org.apache.http.client.methods.HttpUriRequest)>", "com.mvlove.http.HttpWrapper", "post"));
        ...
        resultMap.put("scipiex.apk", new ExpectedResult("<android.content.ContentResolver: android.database.Cursor query(android.net.Uri,java.lang.String[],java.lang.String,java.lang.String[],java.lang.String)>", "com.yxx.jiejie.SMSListenerService", "List readAllContacts", "<java.io.PrintWriter: void println(java.lang.String)>", "com.yxx.jiejie.SMSListenerService.AnonymousClass2$1", "writeToFile"));
        ...
        resultMap.put("stels_flashplayer_android_update.apk", new ExpectedResult("<android.content.ContentResolver: android.database.Cursor query(android.net.Uri,java.lang.String[],java.lang.String,java.lang.String[],java.lang.String)>", "ru.stels2.Functions", "List<String> getContacts", "<java.io.DataOutputStream: void write(byte[])>", "ru.stels2.Functions", "HttpURLConnection sendHttpRequest"));
        resultMap.put("stels_flashplayer_android_update.apk", new ExpectedResult("<android.content.pm.PackageManager: java.util.List getInstalledPackages(int)>", "ru.stels2.Functions", "List<PackageInfo> getInstalledAppList", "<java.io.DataOutputStream: void write(byte[])>", "ru.stels2.Functions", "HttpURLConnection sendHttpRequest"));
        // Still thread.runnable problem?
        resultMap.put("stels_flashplayer_android_update.apk", new ExpectedResult("<android.telephony.TelephonyManager: java.lang.String getSubscriberId()>", "ru.stels2.Functions", "String getImsi", "<java.io.DataOutputStream: void write(byte[])>", "ru.stels2.Functions", "HttpURLConnection sendHttpRequest"));
        resultMap.put("vibleaker_android_samp.apk", new ExpectedResult("<android.os.Environment: java.io.File getExternalStorageDirectory()>", "gr.georkouk.kastorakiacounter_new.MyServerFunctions", "register", "<org.springframework.web.client.RestTemplate: org.springframework.http.ResponseEntity exchange(java.lang.String,org.springframework.http.HttpMethod,org.springframework.http.HttpEntity,java.lang.Class,java.lang.Object[])>", "gr.georkouk.kastorakiacounter_new.MyServerFunctions", "upPst"));
