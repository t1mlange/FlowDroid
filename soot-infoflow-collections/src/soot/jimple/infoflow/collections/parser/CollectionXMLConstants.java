...
public class CollectionXMLConstants {
    // Constant is also in the xsd file
    public static final int MAX_KEYS = 2;

    public static final String COLLECTION_MODEL_TAG = "collectionModel";
    ...
    public static final String CALLBACK_BASE_TAG = "callbackBase";
    public static final String CALLBACK_DATA_TAG = "callbackData";
