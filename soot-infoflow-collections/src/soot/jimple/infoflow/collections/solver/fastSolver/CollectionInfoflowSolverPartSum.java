...
// * - Uses summaries whenever the context wasn't touched
// * - Uses part summaries when we notice a end summary altered the context
// *
// * @author Tim Lange
// */
//public class CollectionInfoflowSolverPartSum extends InfoflowSolver {
...
//
//	private IContainerStrategy container;
//
...
//
//	@SynchronizedBy("Thread-safe data structure")
//	protected final Map<NoContextKey, Set<EndSummary<Unit, Abstraction>>> partialSummaries = new ConcurrentHashMap<>();
//
////	@SynchronizedBy("Thread-safe data structure")
//	protected final MyConcurrentHashMap<NoContextKey, Set<Abstraction>> incomingWContext = new MyConcurrentHashMap<>();
//
...
//	}
//
//	public void setContainerStrategy(IContainerStrategy container) {
...
//		incomingWContext.putIfAbsent(new NoContextKey(m, d3),
...
//
//							if (subsuming != null && subsuming.hasContext(d3)) {
//								Set<Abstraction> absSet = incomingWContext.get(new NoContextKey(sCalledProcUnit, d3));
//								if (absSet != null) {
//									absSet.add(d3);
//
//
...
//
//						// If this statement here affects the context, we should register a part
//						// summary toward this statement
//						if (subsuming.affectsContext(n)
//								&& subsuming.affectsContext(d1, d3)
//								&& !subsuming.affectsContext(d1, d2)) {
//							addPartialSummary(d1, n, d2);
//						}
//
...
//	}
//
//	protected void applyPartialSummariesOnCall() {
//		Set<EndSummary<Unit, Abstraction>> partSums = partialSummaries.get()
//	}
//
//	@Override
...
//	}
//
//	protected boolean addPartialSummary(Abstraction d1, Unit u, Abstraction d2) {
//		// We will never see a call site with zeroValue as a context, thus we can exit here
//		if (d1 == zeroValue)
//			return true;
//
//		boolean added = false;
//		List<Unit> doms = icfg.getAllDominators(u);
//		partialSummaries.computeIfPresent(new NoContextKey(icfg.getMethodOf(u), d1), (key, summaries) -> {
//			for (EndSummary<> sum : summaries) {
//				if (doms.contains(sum))
//			}
//			b = true;
//		});
//
//		// TODO: do I need some dominator?
//		return partialSummaries.put(new NoContextKey(icfg.getMethodOf(u), d1), new PartialSummary<>(u, d2, d1));
//	}
//
//	protected boolean hasPartialSummary(Abstraction d1, Unit u, Abstraction d2) {
//		// We will never see a call site with zeroValue as a context, thus we can exit here
//		if (d1 == zeroValue)
//			return true;
//
