...
/**
 * Infoflow Solver that is able to widen facts at CallToReturn edges
 *
 * @author Tim Lange
 */
public class WideningInfoflowSolver extends InfoflowSolver {
	@SynchronizedBy("Thread-safe class")
	private WideningStrategy<Unit, Abstraction> widening;

	public WideningInfoflowSolver(AbstractInfoflowProblem problem, InterruptableExecutor executor) {
