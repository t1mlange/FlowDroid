...
public class IndexConstraint extends FlowConstraint {
    private ImplicitLocation loc;

    public IndexConstraint(SourceSinkType type, int paramIdx, String baseType, AccessPathFragment accessPathFragment, ImplicitLocation loc) {
